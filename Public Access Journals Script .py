...
for index, row in df.iterrows(): #Checks each row in the DOI columnn
    ...
    elif "10.1073/" in y or "10.1021/" in y:
    ...
    #DOIs of publishers that have both available and unavailable articles 
        ...
        if "fsn3" in y or "gcbb" in y or "pbi" in y or "tpj" in y or "ajb" in y  or "rse" in y:
            print(index, 'YES')
        else:
            print(index, 'NO')
    elif "10.2134/" in y or "10.3198/" in y:
        if "ael" in y or "argonj" in y:
            print(index, 'YES')
        else:
            print(index, 'NO')
    elif "10.1038/" in y:
    ...
    #DOIs of publications that are unavailable
        ...
        print(index, 'NO')
    elif "10.17660/" in y or "10.1079/" in y or "10.3791/" in  or "10.1637/" in y: 
        print(index, 'NO')
